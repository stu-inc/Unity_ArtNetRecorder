...
namespace com.kodai100.ArtNetApp.Presenter
{
    ...
    public class PlayerPresenter : Presenter<PlayerModel>
    {
        ...
        private ArtNetPlayer.ArtNetPlayer _artNetPlayer;
        ...
        public IObservable<Unit> OnToggleIsSending => artNetResendUI.OnToggleClickedAsObservable;
        ...
        public override IEnumerable<IDisposable> Bind(PlayerModel model)
        {
            ...
            _artNetPlayer = new ArtNetPlayer.ArtNetPlayer(MaxUniverseNum);
